# "RAG tool" with Vercel's Generative UI components
...
To keep this post from going any longer than it is already, several basic UI components have been omitted, but you can checkout the full implementation in the [examples directory](https://github.com/DewyKB/dewy-ts/tree/main/examples/rag-tool-vercel).
