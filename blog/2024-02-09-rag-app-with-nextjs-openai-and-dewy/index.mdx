...
This guide will walk you through building a RAG application using [NextJS](https://nextjs.org/) for the web framework, the [OpenAI API](https://platform.openai.com/) for the language model, and [Dewy](https://dewykb.github.io/) as your knowledge base platform. 
