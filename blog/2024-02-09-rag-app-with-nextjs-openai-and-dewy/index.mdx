---
slug: rag-app-with-nextjs-openai-and-dewy
title: Building a RAG chatbot with NextJS, OpenAI & Dewy 
description: This guide will walk you through building a RAG application using NextJS for the web framework, the OpenAI API for the language model, and Dewy as your knowledge base.  
image: ./banner.png
keywords: 
  - Retrieval-Augmented Generation Application
  - RAG Application Development
  - NextJS and OpenAI API Integration
  - Using Dewy for Knowledge Management
  - Building Chatbots with RAG
  - Semantic Search in RAG Applications
  - Document Chunking for AI Responses
  - Reduce AI Hallucinations
  - Implementing Semantic Search with Dewy
  - OpenAI API for Accurate AI Responses
  - Knowledge Extraction and Indexing
  - Handling Large Documents in AI Applications
  - NextJS Tutorial for AI Chatbots
  - Creating Intelligent Chat Applications
  - AI Response Enhancement with Dewy
  - RAG System Challenges and Solutions
  - Augmented Prompt Engineering
  - Programming Chatbots with NextJS
  - Custom Knowledge Bases for AI
  - Enhancing AI with Domain-Specific Knowledge
authors:
  - ryan
---

![NextJS + OpenAI + Dewy](./banner.svg)
...
1. **Install required packages:** Install client libraries for the OpenAI API and Dewy. 

    ```
    npm install openai dewy_ts ai
    ```
...
export async function POST(req: Request) {
    ...
    const document = await dewy.default.addDocument({
...
![See the documents in Dewy](./documents.png)
...
![Explore individual documents and extracted chunks](./document.png)
...
![Search for relevant chunks](./search.png)
